    ...
    public void onClick(View v) {
        ...
        switch (v.getId())
        {
            case R.id.button:
                ...
                PendingIntent in = PendingIntent.getActivity(this,0,intent,0);
                ...
                Notification notification = new NotificationCompat.Builder(this).setContentTitle("This is content title")
                        ...
                        .setLargeIcon(BitmapFactory.decodeResource(getResources(),R.mipmap.ic_launcher)).setContentIntent(in).setAutoCancel(true).build();
